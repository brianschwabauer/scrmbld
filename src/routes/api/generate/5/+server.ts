...
import WORDLIST from './../../../../../static/5-letter-words.txt?raw';
import ALL_WORDS from './../../../../../static/5-letter-words.txt?raw';
...
const PREVIOUS_WORDLIST = { list: [] as string[] };
// const ALL_WORDS = '';

export function GET({ url }) {
	const WORD_LENGTH = 5;
	const numExtraLetters = +(url.searchParams.get('numExtraLetters') || '') || 2;
